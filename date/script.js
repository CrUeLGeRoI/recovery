...
let timer_show = document.querySelector(".data");
...
timer = setInterval(function () {
    ...
    if (ms_left <= 0) { // То
        ...
        let str_timer = `${res.getUTCDate() - 1}.0${res.getUTCMonth()}.${res.getUTCFullYear() - 1970} ${res.getUTCHours()}:${res.getUTCMinutes()}:${res.getUTCSeconds()}`;
        // Выводим время
